...
func.func @dynamic_conv_c2(%arg0: tensor<1x4x4x1xi64>,
...
func.func @dynamic_conv_c4(%arg0: tensor<1x8x8x207xf32>,
    %arg1: tensor<3x3x207x16xf32>) -> tensor<1x8x8x16xf32> {
...
func.func @dynamic_conv_c10(%arg0: tensor<1x8x8x207xf32>,
    %arg1: tensor<3x3x207x16xf32>) -> tensor<1x8x8x16xf32> {
...
func.func @dynamic_conv_c11(%arg0: tensor<5x8x8x207xf32>,
    %arg1: tensor<3x3x207x16xf32>) -> tensor<1x8x8x16xf32> {
...
func.func @dynamic_conv_c12(%arg0: tensor<1x8x8x207xf32>,
...
// but negative here: stablehlo.dynamic_conv does not support unknown dimenstion
// dim_numbers = [b, 0, 1, ?, f]x[0, 1, ?, i, o]->[?, b, 0, 1, f]
// window = {stride = [1, 1], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
func.func @dynamic_conv_c13(%arg0: tensor<1x8x8x32x207xf32>, %arg1: tensor<3x3x32x207x16xf32>) -> tensor<32x1x8x8x16xf32> {
...
func.func @dynamic_conv_c14(%arg0: tensor<1xf32>, %arg1: tensor<3xf32>)
    -> tensor<1x8x8x16xf32> {
...
func.func @dynamic_conv_c14(%arg0 : tensor<100x26x26x32xf32>,
...
func.func @dynamic_conv_c15(%arg0: tensor<1x8x8x207xf32>,
    %arg1: tensor<3x3x20x16xf32>) -> tensor<1x8x8x16xf32> {
...
func.func @dynamic_conv_c16(%arg0: tensor<3x8x8x207xf32>,
...
func.func @dynamic_conv_c18(%arg0: tensor<1x8x8x207xf32>,
    %arg1: tensor<3x3x207x16xf32>) -> tensor<1x8x8x16xf32> {
...
func.func @dynamic_conv_c19(%arg0 : tensor<100x26x26x32xf32>,
    %arg1 : tensor<3x3x1x32xf32>) -> tensor<100x28x28x1xf32> {
...
func.func @dynamic_conv_c20(%arg0: tensor<1x8x8x207xf32>,
    %arg1: tensor<3x3x207x16xf32>) -> tensor<1x8x8x16xf32> {
...
func.func @dynamic_conv_c21(%arg0 : tensor<100x26x26x32xf32>,
    %arg1 : tensor<3x3x1x32xf32>) -> tensor<100x28x28x1xf32> {
...
func.func @dynamic_conv_c24(%arg0: tensor<1x8x8x207xf32>,
    %arg1: tensor<3x3x207x16xf32>) -> tensor<1x8x8x16xf32> {
...
func.func @dynamic_conv_c25(%arg0: tensor<3x2xf16>,
    %arg1: tensor<2x2xf16>) -> tuple<tensor<3x2xf16>> {
