...
#include "third_party/stablehlo/google/builder/FuncBuilder.h"
#include "third_party/stablehlo/google/builder/MlirBuilder.h"
#include "third_party/stablehlo/google/builder/StablehloBuilder.h"
#include "third_party/stablehlo/stablehlo/dialect/Register.h"
...
TEST(MlirBuilderTest, SmokeTest) {
  ...
  {  // Build Main Func
    ...
    auto cst = Constant(fb, mlir::makeConstant(fb.getContext(), 1L, type2xi64));
...
TEST(MlirBuilderTest, ReduceOp) {
  ...
  {  // Build Main Func
    ...
    auto cst = stablehlo::Constant(
        fb, mlir::makeConstant(fb.getContext(), 1L, typei64));
...
TEST(MlirBuilderTest, WhileOp) {
  ...
  {  // Build Main Func
    ...
    auto cst = Constant(fb, mlir::makeConstant(fb.getContext(), 1L, typei64));
    auto whl = While(
        fb, arg0,
...
TEST(MlirBuilderTest, ConstantPRED) {
  ...
  StablehloModuleBuilder mb;
  {
    ...
    auto cst =
        stablehlo::Constant(fb, makeConstant(fb.getContext(), true, type));
    func::Return(fb, {cst});
  }
...
TEST(MlirBuilderTest, ConstantI32) {
  ...
  StablehloModuleBuilder mb;
  {
    ...
    auto cst = stablehlo::Constant(fb, makeConstant(fb.getContext(), 1, type));
    func::Return(fb, {cst});
  }
...
TEST(MlirBuilderTest, ConstantF32) {
  ...
  StablehloModuleBuilder mb;
  {
    ...
    auto cst =
        stablehlo::Constant(fb, makeConstant(fb.getContext(), 1.0, type));
    func::Return(fb, {cst});
  }
...
TEST(MlirBuilderTest, ConstantComplexF32) {
  ...
  StablehloModuleBuilder mb;
  {
    ...
    auto cst = stablehlo::Constant(
        fb,
        makeConstant(fb.getContext(), std::complex<double>(1.0, 2.0), type));
    func::Return(fb, {cst});
  }
...
TEST(MlirBuilderTest, ConstantPREDArray) {
  ...
  StablehloModuleBuilder mb;
  {
    ...
    auto cst = stablehlo::Constant(
        fb, makeConstant(fb.getContext(), ArrayRef<bool>({true, false}), type));
    func::Return(fb, {cst});
  }
...
TEST(MlirBuilderTest, ConstantI2Array) {
  ...
  StablehloModuleBuilder mb;
  {
    ...
    auto cst = stablehlo::Constant(
        fb,
        makeConstant(fb.getContext(), ArrayRef<int64_t>({-2, -1, 0, 1}), type));
    func::Return(fb, {cst});
  }
...
TEST(MlirBuilderTest, ConstantUI2Array) {
  ...
  StablehloModuleBuilder mb;
  {
    ...
    auto cst = stablehlo::Constant(
        fb,
        makeConstant(fb.getContext(), ArrayRef<uint64_t>({0, 1, 2, 3}), type));
    func::Return(fb, {cst});
  }
...
TEST(MlirBuilderTest, ConstantI4Array) {
  ...
  StablehloModuleBuilder mb;
  {
    ...
    auto cst = stablehlo::Constant(
        fb, makeConstant(fb.getContext(), ArrayRef<int64_t>({-8, -1, 0, 1, 7}),
                         type));
    func::Return(fb, {cst});
  }
...
TEST(MlirBuilderTest, ConstantUI4Array) {
  ...
  StablehloModuleBuilder mb;
  {
    ...
    auto cst = stablehlo::Constant(
        fb,
        makeConstant(fb.getContext(), ArrayRef<uint64_t>({0, 8, 15}), type));
    func::Return(fb, {cst});
  }
...
TEST(MlirBuilderTest, ConstantI8Array) {
  ...
  StablehloModuleBuilder mb;
  {
    ...
    auto cst = stablehlo::Constant(
        fb, makeConstant(fb.getContext(),
                         ArrayRef<int8_t>({-128, -9, 0, 8, 127}), type));
    func::Return(fb, {cst});
  }
...
TEST(MlirBuilderTest, ConstantUI8Array) {
  ...
  StablehloModuleBuilder mb;
  {
    ...
    auto cst = stablehlo::Constant(
        fb,
        makeConstant(fb.getContext(), ArrayRef<uint8_t>({0, 16, 255}), type));
    func::Return(fb, {cst});
  }
...
TEST(MlirBuilderTest, ConstantI16Array) {
  ...
  StablehloModuleBuilder mb;
  {
    ...
    auto cst = stablehlo::Constant(
        fb,
        makeConstant(fb.getContext(),
                     ArrayRef<int64_t>({-32768, -129, 0, 128, 32767}), type));
    func::Return(fb, {cst});
  }
...
TEST(MlirBuilderTest, ConstantUI16Array) {
  ...
  StablehloModuleBuilder mb;
  {
    ...
    auto cst = stablehlo::Constant(
        fb, makeConstant(fb.getContext(), ArrayRef<uint64_t>({0, 256, 65535}),
                         type));
    func::Return(fb, {cst});
  }
...
TEST(MlirBuilderTest, ConstantUI32Array) {
  ...
  StablehloModuleBuilder mb;
  {
    ...
    auto cst = stablehlo::Constant(
        fb, makeConstant(fb.getContext(),
                         ArrayRef<uint64_t>({0, 65536, 4294967295}), type));
    func::Return(fb, {cst});
  }
...
TEST(MlirBuilderTest, ConstantI64Array) {
  ...
  StablehloModuleBuilder mb;
  {
    ...
    auto cst = stablehlo::Constant(
        fb,
        makeConstant(fb.getContext(),
                     ArrayRef<int64_t>({-9223372036854775807 - 1, -2147483649,
...
TEST(MlirBuilderTest, ConstantF4E2M1FNArray) {
  ...
  StablehloModuleBuilder mb;
  {
    ...
    auto cst = stablehlo::Constant(
        fb, makeConstant(fb.getContext(),
                         ArrayRef<double>({0.0, -0.0, 1.0, 0.125, 0.1, 3.1415,
                                           0x07, 0x0F, 0x01, 0x09}),
                         type));
    func::Return(fb, {cst});
  }
...
TEST(MlirBuilderTest, ConstantBF16Array) {
  ...
  StablehloModuleBuilder mb;
  {
    ...
    auto cst = stablehlo::Constant(
        fb,
        makeConstant(fb.getContext(),
                     ArrayRef<double>({0.0, -0.0, 1.0, 0.125, 0.1, 3.140630,
...
TEST(MlirBuilderTest, ConstantF32Array) {
  ...
  StablehloModuleBuilder mb;
  {
    ...
    auto cst = stablehlo::Constant(
        fb, makeConstant(fb.getContext(),
                         ArrayRef<double>({0.0, -0.0, 1.0, 0.125, 0.1,
...
TEST(MlirBuilderTest, ConstantComplexF32Array) {
  ...
  StablehloModuleBuilder mb;
  {
    ...
    auto cst = stablehlo::Constant(
        fb,
        makeConstant(fb.getContext(),
                     ArrayRef<std::complex<double>>({{1.5, 2.5}, {3.5, 4.5}}),
                     type));
    func::Return(fb, {cst});
  }
...
TEST(MlirBuilderTest, ConvertElementTypeF32ToI32) {
  ...
  StablehloModuleBuilder mb;
  {
    ...
    auto cst = stablehlo::Constant(fb, makeConstant(ctx, 1.0, type));
