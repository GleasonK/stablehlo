// RUN: stablehlo-opt --chlo-legalize-to-stablehlo -inline %s | stablehlo-translate --interpret
...
module @jit_testcase {
  func.func public @main() -> tensor<i1> {
    ...
    %3 = stablehlo.custom_call @check.expect_close(%2, %1) : (tensor<20x20xbf16>, tensor<20x20xbf16>) -> tensor<i1>
    return %3 : tensor<i1>
  }
